...
export default function ViewConditions() {
  ...
  React.useEffect(() => {
    fetch(
      `${API_BASE_URL}/tooth-condition/conditions/${session?.user?.entity_name}`,
      {
        method: "GET",
      }
    )
  ...
  const columns: GridColDef[] = [
    ...
    { field: "name", headerName: "Possible Tooth Conditon", width: 130 },
  ];
